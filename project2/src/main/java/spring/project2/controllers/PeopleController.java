...
import spring.project2.dao.PersonBookDAO;
...
public class PeopleController {
    ...
    @Autowired
    public PeopleController(PersonBookDAO personBookDAO, PeopleService peopleService, BooksService booksService) {
    ...
    public String show(@PathVariable("id") int id, Model model) {
        ...
        List<Book> books = booksService.getBooks(id);
